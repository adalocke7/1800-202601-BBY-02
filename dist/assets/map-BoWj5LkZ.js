...
</ul>`},n=document.getElementById("Food"),o=document.getElementById("Drinks"),t=document.getElementById("KeyLocations"),s=document.getElementById("Washrooms");n.addEventListener("click",function(){document.getElementById("info").innerHTML=e.Food});o.addEventListener("click",function(){document.getElementById("info").innerHTML=e.Drinks});t.addEventListener("click",function(){document.getElementById("info").innerHTML=e.KeyLocations});s.addEventListener("click",function(){document.getElementById("info").innerHTML=e.Washrooms});
